...
const run = resolve('.ai-work/runs/20260917-template-adoption')
if (process.argv[2] === 'child') {
  ...
  try {
    ...
    assert.equal(retainedIdentities, candidate ? 10_000 : 102_000)
    store.shutdown()
